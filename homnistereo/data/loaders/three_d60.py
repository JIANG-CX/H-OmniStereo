...
def load_sample(
    ...
    top_path = dataset_root / "Up" / sample_dir / f"{sample_name}_color_0_Up_0.0.png"
    bottom_dir = dataset_root / "Center_Left_Down" / sample_dir
    bottom_path = bottom_dir / f"{sample_name}_color_0_Left_Down_0.0.png"
    depth_path = bottom_dir / f"{sample_name}_depth_0_Left_Down_0.0.exr"
